...
export const communicationStyle: ProfileAssessmentConfig = {
  ...
  meta: {
    ...
    description:
      "Identify your communication pattern when sharing ideas, giving feedback and handling disagreement. Ten situational questions, instant private results.",
    purpose:
      "Identifies the communication pattern a person most often uses when sharing ideas, requesting action, giving feedback and handling disagreement.",
  ...
  profileQuestions: [
    {
      id: "a12q1",
      text: "When you disagree in a meeting, you usually:",
      options: [
    ...
    {
      id: "a12q2",
      text: "When someone is upset with you, you first:",
      options: [
    ...
    {
      id: "a12q3",
      text: "Your messages are usually:",
      options: [
    ...
    {
      id: "a12q4",
      text: "When instructions are unclear, you:",
      options: [
    ...
    {
      id: "a12q5",
      text: "People may occasionally experience you as:",
      options: [
    ...
    {
      id: "a12q7",
      text: "In conflict, your priority is:",
      options: [
    ...
    {
      id: "a12q9",
      text: "Your strongest communication asset is:",
      options: [
    ...
    {
      id: "a12q10",
      text: "Your most useful growth area is:",
      options: [
  ...
  profiles: [
    {
      code: "A",
      label: "Reflective Listener",
      meaning: "Processes carefully, listens deeply and speaks after considering the situation.",
      interpretation:
        "Your responses suggest you process carefully, listen deeply and speak after considering the situation.",
      nextStep:
        "Prepare one sentence in advance and contribute earlier in important conversations.",
      color: "blue",
    },
    {
      code: "B",
      label: "Diplomatic Connector",
      meaning: "Protects relationships and builds agreement through tact and empathy.",
      interpretation:
        "Your responses suggest you protect relationships and build agreement through tact and empathy.",
      nextStep:
        "Practise naming the request or boundary directly after acknowledging the relationship.",
      color: "emerald",
    },
    {
      code: "C",
      label: "Clear Advocate",
      meaning: "Expresses needs, facts and boundaries directly while respecting others.",
      interpretation:
        "Your responses suggest you express needs, facts and boundaries directly while respecting others.",
      nextStep: "Keep the clarity, while checking how much context and warmth the listener needs.",
      color: "yellow",
    },
    {
      code: "D",
      label: "Direct Driver",
      meaning: "Communicates quickly, strongly and with emphasis on action or decision.",
      interpretation:
        "Your responses suggest you communicate quickly, strongly and with emphasis on action or decision.",
      nextStep:
        "Pause, ask one question and summarise the other person before pressing for action.",
      color: "orange",
    },
  ],
  dimensions: [],
