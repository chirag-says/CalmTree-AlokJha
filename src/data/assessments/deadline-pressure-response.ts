...
export const deadlinePressureResponse: ProfileAssessmentConfig = {
  ...
  meta: {
    ...
    description:
      "Discover your typical behavioural pattern as deadlines approach and pressure increases.",
    purpose:
      "Shows the person's typical behavioural pattern as deadlines approach and pressure increases.",
  ...
  profileQuestions: [
    {
      id: "w12q1",
      text: "When a deadline is assigned, you first:",
      options: [
    ...
    {
      id: "w12q2",
      text: "Your productivity is highest:",
      options: [
    ...
    {
      id: "w12q3",
      text: "If a deadline moves earlier, you:",
      options: [
    ...
    {
      id: "w12q4",
      text: "You use reminders and trackers:",
      options: [
    ...
    {
      id: "w12q5",
      text: "A long deadline can lead you to:",
      options: [
    ...
    {
      id: "w12q6",
      text: "Under time pressure, quality usually:",
      options: [
    ...
    {
      id: "w12q7",
      text: "Your main deadline risk is:",
      options: [
    ...
    {
      id: "w12q9",
      text: "You most need from a manager:",
      options: [
  ...
  profiles: [
    {
      code: "A",
      label: "Early Planner",
      meaning: "Reduces pressure through early structure and steady progress.",
      interpretation:
        "Your responses suggest you reduce pressure through early structure and steady progress.",
      nextStep: "Time-box planning and begin a small deliverable early.",
      color: "blue",
    },
    {
      code: "B",
      label: "Steady Executor",
      meaning: "Works consistently and increases pace as the deadline approaches.",
      interpretation:
        "Your responses suggest you work consistently and increase pace as the deadline approaches.",
      nextStep: "Add contingency for complexity and communicate trade-offs before the final stage.",
      color: "emerald",
    },
    {
      code: "C",
      label: "Deadline Sprinter",
      meaning: "Uses urgency to create focus and completes much of the work late.",
      interpretation:
        "Your responses suggest you use urgency to create focus and complete much of the work late.",
      nextStep: "Create external mid-point commitments and protect review time.",
      color: "yellow",
    },
    {
      code: "D",
      label: "Pressure Freezer",
      meaning: "Loses clarity or delays action when urgency becomes intense.",
      interpretation:
        "Your responses suggest you may lose clarity or delay action when urgency becomes intense.",
      nextStep:
        "Define a five-minute first action and ask for prioritisation before pressure escalates.",
      color: "orange",
    },
  ],
  dimensions: [],
