...
export const detailVsBigPicture: ProfileAssessmentConfig = {
  ...
  meta: {
    ...
    description: "Identify whether you naturally focus on accuracy, systems, strategic direction or translating between levels.",
    purpose: "Identifies whether a person naturally focuses on accuracy, interconnected systems, strategic direction or translating between levels.",
  ...
  profileQuestions: [
    { id: "w9q1", text: "When reviewing a proposal, your attention goes first to:", options: [
    ...
    { id: "w9q2", text: "In planning, you most naturally ask:", options: [
    ...
    { id: "w9q3", text: "A presentation feels weak when it lacks:", options: [
    ...
    { id: "w9q4", text: "You are most likely to notice:", options: [
    ...
    { id: "w9q5", text: "When discussing the future, you:", options: [
    ...
    { id: "w9q6", text: "Your best contribution is often:", options: [
    ...
    { id: "w9q7", text: "You become frustrated by:", options: [
    ...
    { id: "w9q8", text: "When time is short, you prioritise:", options: [
    ...
    { id: "w9q9", text: "People may experience you as:", options: [
    ...
    { id: "w9q10", text: "Your development priority is:", options: [
  ...
  profiles: [
    { code: "A", label: "Precision Specialist", meaning: "Notices detail, quality standards and execution accuracy.", interpretation: "Your responses suggest you notice detail, quality standards and execution accuracy.", nextStep: "Ask what larger outcome the detail is protecting.", color: "blue" },
    { code: "B", label: "Systems Thinker", meaning: "Looks for relationships, dependencies and second-order effects.", interpretation: "Your responses suggest you look for relationships, dependencies and second-order effects.", nextStep: "Convert system insight into a small number of practical choices.", color: "emerald" },
    { code: "C", label: "Strategic Visionary", meaning: "Focuses on direction, possibility and long-term impact.", interpretation: "Your responses suggest you focus on direction, possibility and long-term impact.", nextStep: "Add evidence, milestones and ownership to the vision.", color: "purple" },
    { code: "D", label: "Strategy-to-Action Bridge", meaning: "Moves between broad goals and operational detail.", interpretation: "Your responses suggest you move between broad goals and operational detail.", nextStep: "Avoid being the only person who connects strategy and execution; build shared understanding.", color: "yellow" },
  ],
  dimensions: [],
};
