...
export const feedbackResponseStyle: ProfileAssessmentConfig = {
  ...
  order: 37, type: "profile-based", tier: "professional", category: "Professional", status: "active",
  meta: { title: "Feedback Response Style", subtitle: "How do you respond to feedback?", description: "Identify your default response when receiving evaluative, critical or corrective feedback.", purpose: "Identifies the person's default response when receiving evaluative, critical or corrective feedback.", duration: "3–5 minutes", questionCount: 10, icon: "message-circle", productCategory: "Leadership & Teams", isFree: false },
  ...
  profileQuestions: [
    { id: "w22q1", text: "When a manager points out a weakness, you first:", options: [
    ...
    { id: "w22q2", text: "After critical feedback, your energy:", options: [
    ...
    { id: "w22q3", text: "You replay feedback in your mind:", options: [
    ...
    { id: "w22q4", text: "When feedback contradicts your self-image, you:", options: [
    ...
    { id: "w22q5", text: "After feedback you usually:", options: [
    ...
    { id: "w22q6", text: "You request feedback:", options: [
    ...
    { id: "w22q7", text: "The most helpful feedback for you:", options: [
    ...
    { id: "w22q8", text: "When feedback feels unfair, you:", options: [
    ...
    { id: "w22q9", text: "Your feedback strength is:", options: [
    ...
    { id: "w22q10", text: "Your development priority is:", options: [
  ...
  profiles: [
    { code: "A", label: "Sensitive Absorber", meaning: "Takes feedback deeply and may over-internalise criticism.", interpretation: "Your responses suggest you take feedback deeply and may over-internalise criticism.", nextStep: "Separate the actionable point from the emotional impact before responding.", color: "blue" },
    { code: "B", label: "Constructive Processor", meaning: "Evaluates feedback, extracts the useful part and acts.", interpretation: "Your responses suggest you evaluate feedback, extract the useful part and act.", nextStep: "Continue seeking harder feedback in areas that matter most.", color: "emerald" },
    { code: "C", label: "Engaged Responder", meaning: "Treats feedback as a conversation and clarifies context.", interpretation: "Your responses suggest you treat feedback as a conversation and clarify context.", nextStep: "Listen fully before presenting your perspective.", color: "yellow" },
    { code: "D", label: "Resilient Deflector", meaning: "Maintains confidence but may filter out uncomfortable truths.", interpretation: "Your responses suggest you maintain confidence but may filter out uncomfortable truths.", nextStep: "Sit with feedback for a day before deciding whether it is relevant.", color: "orange" },
  ],
  dimensions: [],
};
