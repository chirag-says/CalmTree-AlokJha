...
export const independenceVsCollaboration: ProfileAssessmentConfig = {
  ...
  meta: {
    ...
    description: "Discover how you prefer to divide thinking, ownership and execution between individual and group work.",
    purpose: "Shows how a person prefers to divide thinking, ownership and execution between individual and group work.",
  ...
  profileQuestions: [
    { id: "w8q1", text: "When given a complex assignment, you prefer to:", options: [
    ...
    { id: "w8q2", text: "Your best ideas usually emerge when you:", options: [
    ...
    { id: "w8q3", text: "A collaborative project feels difficult when:", options: [
    ...
    { id: "w8q4", text: "When a problem appears, you:", options: [
    ...
    { id: "w8q5", text: "Your preferred ownership model is:", options: [
    ...
    { id: "w8q6", text: "You contribute best in a team by:", options: [
    ...
    { id: "w8q7", text: "When meetings increase, you:", options: [
    ...
    { id: "w8q8", text: "When a colleague offers help, you:", options: [
    ...
    { id: "w8q9", text: "People may experience you as:", options: [
    ...
    { id: "w8q10", text: "Your development priority is:", options: [
  ...
  profiles: [
    { code: "A", label: "Solo Specialist", meaning: "Prefers deep individual ownership and minimal coordination.", interpretation: "Your responses suggest you prefer deep individual ownership and minimal coordination.", nextStep: "Invite targeted input before your work is too complete to change.", color: "blue" },
    { code: "B", label: "Independent Collaborator", meaning: "Likes personal ownership with targeted input at key moments.", interpretation: "Your responses suggest you like personal ownership with targeted input at key moments.", nextStep: "Tell collaborators exactly when and what kind of input is useful.", color: "emerald" },
    { code: "C", label: "Balanced Partner", meaning: "Moves comfortably between solo focus and shared problem-solving.", interpretation: "Your responses suggest you move comfortably between solo focus and shared problem-solving.", nextStep: "Choose the mode intentionally rather than defaulting to whichever is easiest.", color: "yellow" },
    { code: "D", label: "Team Integrator", meaning: "Thinks and performs best through frequent exchange and shared ownership.", interpretation: "Your responses suggest you think and perform best through frequent exchange and shared ownership.", nextStep: "Protect some individual focus time and avoid unnecessary group dependency.", color: "purple" },
  ],
  dimensions: [],
};
