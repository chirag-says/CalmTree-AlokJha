...
export const leadershipDNA: ProfileAssessmentConfig = {
  ...
  meta: {
    ...
    description: "Discover your leadership style across personal example, management discipline, relational influence and vision building.",
  ...
  profileQuestions: [
    { id: "a9q1", text: "A team is uncertain about a new assignment. You first:", options: [
    ...
    { id: "a9q2", text: "When performance drops, you tend to:", options: [
    ...
    { id: "a9q3", text: "People are most likely to follow you because you:", options: [
    ...
    { id: "a9q4", text: "In a disagreement, you usually:", options: [
    ...
    { id: "a9q5", text: "Your strongest leadership contribution is:", options: [
    ...
    { id: "a9q6", text: "When change is required, you:", options: [
    ...
    { id: "a9q7", text: "You are most uncomfortable when:", options: [
    ...
    { id: "a9q8", text: "You develop other people mainly by:", options: [
    ...
    { id: "a9q9", text: "Under pressure, you rely on:", options: [
    ...
    { id: "a9q10", text: "Your next leadership step is most likely to involve:", options: [
  ...
  profiles: [
    { code: "A", label: "Emerging Leader", meaning: "Builds leadership through self-management, learning and dependable contribution.", interpretation: "Your responses suggest you build leadership through self-management, learning and dependable contribution.", nextStep: "Take ownership of a small leadership situation and request specific feedback.", color: "blue" },
    { code: "B", label: "Reliable Manager", meaning: "Creates clarity, process, accountability and consistent delivery.", interpretation: "Your responses suggest you create clarity, process, accountability and consistent delivery.", nextStep: "Practise delegation and coaching so structure does not become over-control.", color: "emerald" },
    { code: "C", label: "Influential Guide", meaning: "Builds commitment through trust, coaching and communication.", interpretation: "Your responses suggest you build commitment through trust, coaching and communication.", nextStep: "Pair empathy with clear standards and timely decisions.", color: "yellow" },
    { code: "D", label: "Visionary Builder", meaning: "Creates direction, possibility and momentum around a larger goal.", interpretation: "Your responses suggest you create direction, possibility and momentum around a larger goal.", nextStep: "Translate the vision into milestones, owners and operating rhythms.", color: "purple" },
  ],
  dimensions: [],
};
