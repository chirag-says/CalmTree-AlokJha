...
export const learningStyle: ProfileAssessmentConfig = {
  ...
  meta: {
    ...
    description: "Discover the learning formats you naturally prefer while encouraging a flexible, mixed-method approach. Ten situational questions, instant private results.",
    purpose: "Highlights the learning formats a person naturally prefers while encouraging a flexible, mixed-method approach.",
  ...
  profileQuestions: [
    { id: "a13q1", text: "When learning a new concept, you prefer to begin with:", options: [
    ...
    { id: "a13q2", text: "You remember information best when you:", options: [
    ...
    { id: "a13q3", text: "A difficult topic becomes clearer when:", options: [
    ...
    { id: "a13q4", text: "In an online course, you value most:", options: [
    ...
    { id: "a13q5", text: "When preparing to teach someone, you:", options: [
    ...
    { id: "a13q6", text: "When instructions are confusing, you:", options: [
    ...
    { id: "a13q7", text: "Your notes usually contain:", options: [
    ...
    { id: "a13q8", text: "You lose interest fastest when learning is:", options: [
    ...
    { id: "a13q9", text: "You test understanding by:", options: [
    ...
    { id: "a13q10", text: "The best learning plan for you combines your preference with:", options: [
  ...
  profiles: [
    { code: "A", label: "Visual Mapper", meaning: "Learns by seeing relationships, diagrams, examples and organised visual structure.", interpretation: "Your responses suggest you learn by seeing relationships, diagrams, examples and organised visual structure.", nextStep: "Add retrieval practice and real tasks so visual understanding becomes usable skill.", color: "blue" },
    { code: "B", label: "Verbal Explorer", meaning: "Learns by discussing, explaining and hearing ideas in language.", interpretation: "Your responses suggest you learn by discussing, explaining and hearing ideas in language.", nextStep: "After discussion, write a short summary to check independent understanding.", color: "emerald" },
    { code: "C", label: "Practical Experimenter", meaning: "Learns by doing, testing and receiving immediate feedback.", interpretation: "Your responses suggest you learn by doing, testing and receiving immediate feedback.", nextStep: "Pause after practice to name the principle behind what worked.", color: "yellow" },
    { code: "D", label: "Reflective Reader", meaning: "Learns through reading, note-making and private reflection.", interpretation: "Your responses suggest you learn through reading, note-making and private reflection.", nextStep: "Add explanation, examples and action so reading does not remain passive.", color: "purple" },
  ],
  dimensions: [],
};
