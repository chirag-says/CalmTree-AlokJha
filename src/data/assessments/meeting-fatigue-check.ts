...
export const meetingFatigueCheck: AssessmentConfig = {
  ...
  meta: {
    ...
    purpose:
      "Measures cognitive, social and schedule-related fatigue created by the number, length and design of meetings.",
  ...
  questions: [
    {
      id: "w15q1",
      text: "I have enough gaps between meetings to reset and prepare.",
      options: [...LIKERT_5],
      reverse: true,
      dimension: "recovery-gaps",
    },
    {
      id: "w15q2",
    ...
    {
      id: "w15q3",
      text: "Many meetings could be replaced by a short written update.",
      options: [...LIKERT_5],
      dimension: "meeting-necessity",
    },
    {
      id: "w15q4",
      text: "Meeting agendas and expected decisions are usually clear.",
      options: [...LIKERT_5],
      reverse: true,
      dimension: "meeting-design",
    },
    {
      id: "w15q5",
      text: "I struggle to complete focused work because meetings fragment the day.",
      options: [...LIKERT_5],
      dimension: "focus-interference",
    },
    {
      id: "w15q6",
      text: "I can contribute meaningfully without feeling socially depleted.",
      options: [...LIKERT_5],
      reverse: true,
      dimension: "social-load",
    },
    {
      id: "w15q7",
      text: "Meetings regularly continue longer than their useful purpose.",
      options: [...LIKERT_5],
      dimension: "duration",
    },
    {
      id: "w15q8",
      text: "I know when my attendance is optional rather than expected.",
      options: [...LIKERT_5],
      reverse: true,
      dimension: "attendance-clarity",
    },
    {
      id: "w15q9",
      text: "Video meetings create additional strain through constant screen presence.",
      options: [...LIKERT_5],
      dimension: "digital-load",
    },
    {
      id: "w15q10",
      text: "At the end of a meeting-heavy day, I still have usable mental energy.",
      options: [...LIKERT_5],
      reverse: true,
      dimension: "energy",
    },
  ...
  archetypes: [
    {
      min: 10,
      max: 19,
      label: "Low Meeting Strain",
      color: "green",
      interpretation:
        "Your responses currently show relatively few signs of meeting fatigue. Protective habits appear to be working reasonably well.",
      nextStep:
    ...
    },
    {
      min: 20,
      max: 29,
      label: "Manageable Meeting Load",
      color: "yellow",
      interpretation:
        "Some signs of meeting fatigue are present, especially during demanding periods, but they may still be manageable with deliberate adjustments.",
      nextStep:
    ...
    },
    {
      ...
      color: "orange",
      interpretation:
        "Your responses suggest a recurring pattern of meeting fatigue that may be affecting energy, concentration, relationships or performance.",
      nextStep:
    ...
    },
    {
      ...
      color: "red",
      interpretation:
        "Your responses suggest a strong and persistent pattern of meeting fatigue. The present pace or environment may be difficult to sustain.",
      nextStep:
