...
export const pressureDecisionStyle: ProfileAssessmentConfig = {
  ...
  meta: {
    ...
    purpose:
      "Identifies the decision pattern a person relies on when time is limited and consequences matter.",
  ...
  profileQuestions: [
    {
      id: "w18q1",
      text: "A decision must be made within an hour. You first:",
      options: [
    ...
    {
      id: "w18q2",
      text: "When information conflicts, you:",
      options: [
    ...
    {
      id: "w18q3",
      text: "Your pressure strength is:",
      options: [
    ...
    {
      id: "w18q4",
      text: "Your pressure blind spot may be:",
      options: [
    ...
    {
      id: "w18q5",
      text: "When consequences are high, you:",
      options: [
    ...
    {
      id: "w18q6",
      text: "A team is waiting for direction. You:",
      options: [
    ...
    {
      id: "w18q7",
      text: "Pressure makes you rely more on:",
      options: [
    ...
    {
      id: "w18q9",
      text: "Others value you under pressure because you:",
      options: [
  ...
  profiles: [
    {
      code: "A",
      label: "Rapid Decider",
      meaning: "Chooses quickly and values momentum under pressure.",
      interpretation:
        "Your responses suggest you choose quickly and value momentum under pressure.",
      nextStep: "Use a short pause to check the biggest assumption and irreversible risk.",
      color: "blue",
    },
    {
      code: "B",
      label: "Analytical Checker",
      meaning: "Slows down to verify evidence, risk and assumptions.",
      interpretation:
        "Your responses suggest you slow down to verify evidence, risk and assumptions.",
      nextStep: "Set a clear decision deadline and define what evidence is sufficient.",
      color: "emerald",
    },
    {
      code: "C",
      label: "Consultative Decider",
      meaning: "Seeks stakeholder input and shared understanding.",
      interpretation: "Your responses suggest you seek stakeholder input and shared understanding.",
      nextStep: "Limit consultation to the people with relevant information or consequence.",
      color: "yellow",
    },
    {
      code: "D",
      label: "Risk Protector",
      meaning: "Prioritises avoiding serious downside or irreversible error.",
      interpretation:
        "Your responses suggest you prioritise avoiding serious downside or irreversible error.",
      nextStep: "Separate reversible experiments from truly irreversible decisions.",
      color: "orange",
    },
    {
      code: "E",
      label: "Adaptive Improviser",
      meaning: "Makes a workable decision and adjusts as events unfold.",
      interpretation:
        "Your responses suggest you make a workable decision and adjust as events unfold.",
      nextStep: "Keep the objective and review criteria stable even when method changes.",
      color: "purple",
    },
  ],
  dimensions: [],
