...
export const recognitionNeedAtWork: ProfileAssessmentConfig = {
  ...
  meta: {
    ...
    description: "Identify the form of recognition that most strongly supports your motivation and perceived value at work.",
    purpose: "Identifies the form of recognition that most strongly supports motivation and perceived value at work.",
  ...
  profileQuestions: [
    { id: "w7q1", text: "After strong work, the most satisfying response is:", options: [
    ...
    { id: "w7q2", text: "When your contribution is not recognised, you:", options: [
    ...
    { id: "w7q3", text: "Praise feels most meaningful when it is:", options: [
    ...
    { id: "w7q4", text: "You are most likely to speak about an achievement to:", options: [
    ...
    { id: "w7q5", text: "A reward system should primarily recognise:", options: [
    ...
    { id: "w7q6", text: "When someone else receives credit for joint work, you:", options: [
    ...
    { id: "w7q7", text: "You feel most valued when:", options: [
    ...
    { id: "w7q8", text: "Your biggest recognition frustration is:", options: [
    ...
    { id: "w7q9", text: "If recognition is scarce, you usually:", options: [
    ...
    { id: "w7q10", text: "Your development priority is:", options: [
  ...
  profiles: [
    { code: "A", label: "Intrinsic Contributor", meaning: "Draws satisfaction mainly from quality, usefulness and personal standards.", interpretation: "Your responses suggest you draw satisfaction mainly from quality, usefulness and personal standards.", nextStep: "Make impact visible so intrinsic motivation does not lead to being overlooked.", color: "blue" },
    { code: "B", label: "Private Appreciator", meaning: "Values sincere acknowledgement without high visibility.", interpretation: "Your responses suggest you value sincere acknowledgement without high visibility.", nextStep: "Request specific feedback rather than waiting for others to notice.", color: "emerald" },
    { code: "C", label: "Visible Recognition Seeker", meaning: "Feels energised when contribution is publicly noticed.", interpretation: "Your responses suggest you feel energised when contribution is publicly noticed.", nextStep: "Separate healthy visibility from constant comparison with others.", color: "yellow" },
    { code: "D", label: "Advancement-Oriented Achiever", meaning: "Connects recognition with responsibility, influence or progression.", interpretation: "Your responses suggest you connect recognition with responsibility, influence or progression.", nextStep: "Define success beyond titles so progress remains sustainable and meaningful.", color: "purple" },
  ],
  dimensions: [],
};
