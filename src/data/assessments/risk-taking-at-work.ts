...
export const riskTakingAtWork: ProfileAssessmentConfig = {
  ...
  meta: {
    ...
    description:
      "Identify how you balance opportunity, uncertainty, evidence and downside when making work decisions.",
    purpose:
      "Identifies how a person balances opportunity, uncertainty, evidence and downside when making work decisions.",
  ...
  profileQuestions: [
    {
      id: "w4q1",
      text: "A new idea could create major value but evidence is limited. You:",
      options: [
    ...
    {
      id: "w4q2",
      text: "When choosing between a safe improvement and uncertain breakthrough, you:",
      options: [
    ...
    {
      id: "w4q3",
      text: "A proposal has a 30% chance of high reward. You first ask:",
      options: [
    ...
    {
      id: "w4q4",
      text: "Your response to incomplete information is to:",
      options: [
    ...
    {
      id: "w4q6",
      text: "When an experiment fails, you:",
      options: [
    ...
    {
      id: "w4q7",
      text: "You are most uncomfortable with:",
      options: [
    ...
    {
      id: "w4q8",
      text: "Before making a risky commitment, you need:",
      options: [
    ...
    {
      id: "w4q9",
      text: "Your preferred portfolio is:",
      options: [
    ...
    {
      id: "w4q10",
      text: "Your best growth step is to:",
      options: [
  ...
  profiles: [
    {
      ...
      meaning: "Minimises downside and prefers proven options.",
      interpretation: "Your responses suggest you minimise downside and prefer proven options.",
      nextStep:
        "Use small reversible experiments to build evidence without taking uncontrolled risk.",
      color: "blue",
    },
    {
      code: "B",
      label: "Calculated Experimenter",
      meaning: "Takes limited, testable risks with safeguards.",
      interpretation: "Your responses suggest you take limited, testable risks with safeguards.",
      nextStep: "Avoid making every experiment too small to reveal meaningful information.",
      color: "emerald",
    },
    {
      code: "C",
      label: "Opportunity Seeker",
      meaning: "Moves towards promising possibilities with moderate analysis.",
      interpretation:
        "Your responses suggest you move towards promising possibilities with moderate analysis.",
      nextStep: "Set explicit downside limits and decision review points.",
      color: "yellow",
    },
    {
      code: "D",
      label: "Bold Pioneer",
      meaning: "Accepts substantial uncertainty in pursuit of high potential.",
      interpretation:
        "Your responses suggest you accept substantial uncertainty in pursuit of high potential.",
      nextStep: "Use staged commitments, pre-mortems and stop rules before major bets.",
      color: "orange",
    },
  ],
  dimensions: [],
