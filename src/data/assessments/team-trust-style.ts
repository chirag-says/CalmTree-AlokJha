...
export const teamTrustStyle: ProfileAssessmentConfig = {
  ...
  meta: {
    ...
    subtitle: "How do you build and evaluate trust?",
    description:
      "Identify how you build, evaluate and extend trust in teams and work relationships.",
    purpose: "Identifies how a person builds, evaluates and extends trust in work relationships.",
  ...
  profileQuestions: [
    {
      id: "w23q1",
      text: "With a new colleague, you usually:",
      options: [
    ...
    {
      id: "w23q2",
      text: "Trust is most strongly built through:",
      options: [
    ...
    {
      id: "w23q3",
      text: "When someone makes a mistake, you:",
      options: [
    ...
    {
      id: "w23q4",
      text: "You delegate important work when:",
      options: [
    ...
    {
      id: "w23q5",
      text: "A breach of trust causes you to:",
      options: [
    ...
    {
      id: "w23q7",
      text: "You feel most trusted when:",
      options: [
    ...
    {
      id: "w23q8",
      text: "In a new team, trust develops for you through:",
      options: [
    ...
    {
      id: "w23q9",
      text: "People may perceive you as:",
      options: [
  ...
  profiles: [
    {
      ...
      meaning: "Trusts slowly after sustained evidence of reliability.",
      interpretation:
        "Your responses suggest you trust slowly after sustained evidence of reliability.",
      nextStep: "Extend small trust earlier and adjust rather than waiting for full proof.",
      color: "blue",
    },
    {
      code: "B",
      label: "Structured Truster",
      meaning: "Uses roles, agreements and accountability to build trust.",
      interpretation:
        "Your responses suggest you use roles, agreements and accountability to build trust.",
      nextStep: "Add personal connection so structure does not feel impersonal.",
      color: "emerald",
    },
    {
      code: "C",
      label: "Proactive Truster",
      meaning: "Extends trust early and corrects quickly when needed.",
      interpretation:
        "Your responses suggest you extend trust early and correct quickly when needed.",
      nextStep: "Set clearer boundaries so early trust does not become unchecked risk.",
      color: "yellow",
    },
    {
      code: "D",
      label: "Relationship Truster",
      meaning: "Trusts through personal warmth, openness and assumed good intent.",
      interpretation:
        "Your responses suggest you trust through personal warmth, openness and assumed good intent.",
      nextStep: "Verify through evidence and respond promptly when trust is violated.",
      color: "purple",
    },
  ],
  dimensions: [],
