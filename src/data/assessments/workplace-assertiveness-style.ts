...
export const workplaceAssertiveness: ProfileAssessmentConfig = {
  ...
  meta: {
    ...
    description:
      "Discover how you express opinions, requests, boundaries and disagreement at work.",
    purpose:
      "Shows how a person expresses opinions, requests, boundaries and disagreement at work.",
  ...
  profileQuestions: [
    {
      id: "w5q1",
      text: "A colleague repeatedly misses a commitment that affects you. You:",
      options: [
    ...
    {
      id: "w5q2",
      text: "When your manager assigns unrealistic work, you:",
      options: [
    ...
    {
      id: "w5q3",
      text: "In meetings, you speak when:",
      options: [
    ...
    {
      id: "w5q4",
      text: "When someone interrupts you, you:",
      options: [
    ...
    {
      id: "w5q6",
      text: "During disagreement, you prioritise:",
      options: [
    ...
    {
      id: "w5q8",
      text: "When asking for recognition or resources, you:",
      options: [
    ...
    {
      id: "w5q9",
      text: "If a policy seems unfair, you:",
      options: [
  ...
  profiles: [
    {
      code: "A",
      label: "Accommodating Supporter",
      meaning: "Protects harmony and often yields to others.",
      interpretation: "Your responses suggest you protect harmony and often yield to others.",
      nextStep: "Practise one clear request or boundary in a low-risk situation.",
      color: "blue",
    },
    {
      code: "B",
      label: "Diplomatic Contributor",
      meaning: "Expresses concerns tactfully and looks for mutual agreement.",
      interpretation:
        "Your responses suggest you express concerns tactfully and look for mutual agreement.",
      nextStep: "Keep the tact, but state the actual need before offering compromise.",
      color: "emerald",
    },
    {
      code: "C",
      label: "Clear Advocate",
      meaning: "States needs, limits and views directly while respecting others.",
      interpretation:
        "Your responses suggest you state needs, limits and views directly while respecting others.",
      nextStep: "Continue using clear language and check how context affects delivery.",
      color: "yellow",
    },
    {
      code: "D",
      label: "Forceful Challenger",
      meaning: "Pushes strongly for a position and may prioritise outcome over comfort.",
      interpretation:
        "Your responses suggest you push strongly for a position and may prioritise outcome over comfort.",
      nextStep: "Use questions and impact statements before applying stronger pressure.",
      color: "orange",
    },
  ],
  dimensions: [],
