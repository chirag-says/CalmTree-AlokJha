...
export const workplacePersonalityStyle: ProfileAssessmentConfig = {
  ...
  profileQuestions: [
    {
      id: "wp1q1",
      text: "A new project has a broad outcome but few details. What do you do first?",
      options: [
  ...
  profiles: [
    {
      ...
      interpretation: "Your responses suggest you bring reliability and organisation to your work.",
      nextStep: "Protect planning time, while practising action without complete certainty.",
      color: "blue",
    },
    {
      code: "B",
      ...
      interpretation: "Your responses suggest you are energised by variety and challenge.",
      nextStep: "Add checkpoints so flexibility does not become unfinished work.",
      color: "emerald",
    },
    {
      code: "C",
      ...
      interpretation: "Your responses suggest you naturally draw people together.",
    ...
    },
    {
      ...
      interpretation: "Your responses suggest you bring rigour and precision to your work.",
      nextStep: "Set decision deadlines so analysis does not delay action.",
      color: "purple",
    },
    {
      code: "E",
      ...
      interpretation: "Your responses suggest you create momentum and get things done.",
      nextStep: "Slow down briefly for risk, stakeholder input and follow-through.",
      color: "orange",
    },
  ],
  dimensions: [],
