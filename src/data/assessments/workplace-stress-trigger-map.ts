...
export const workplaceStressTriggerMap: ProfileAssessmentConfig = {
  ...
  meta: {
    ...
    description: "Identify the work condition most likely to activate your stress: workload, uncertainty, relationships, control or evaluation.",
    purpose: "Identifies the work condition most likely to activate stress: workload, uncertainty, relationships, control or evaluation.",
  ...
  profileQuestions: [
    { id: "w11q1", text: "Which situation raises your tension fastest?", options: [
    ...
    { id: "w11q2", text: "Before a difficult workday, you worry most about:", options: [
    ...
    { id: "w11q3", text: "When pressure continues, your thoughts focus on:", options: [
    ...
    { id: "w11q4", text: "A change announcement is stressful mainly when:", options: [
    ...
    { id: "w11q5", text: "In meetings, you feel most stressed by:", options: [
    ...
    { id: "w11q6", text: "Your body reacts most strongly when:", options: [
    ...
    { id: "w11q7", text: "The reassurance that helps most is:", options: [
    ...
    { id: "w11q8", text: "You recover faster when:", options: [
    ...
    { id: "w11q9", text: "A recurring work frustration is:", options: [
    ...
    { id: "w11q10", text: "Your best stress plan should first address:", options: [
  ...
  profiles: [
    { code: "A", label: "Workload Trigger", meaning: "Stress rises mainly when volume, pace or competing demands exceed capacity.", interpretation: "Your responses suggest stress rises mainly when volume, pace or competing demands exceed capacity.", nextStep: "Use capacity planning, explicit trade-offs and workload boundaries.", color: "blue" },
    { code: "B", label: "Uncertainty Trigger", meaning: "Stress rises when expectations, information or outcomes are unclear.", interpretation: "Your responses suggest stress rises when expectations, information or outcomes are unclear.", nextStep: "Ask what is known, unknown and next review point rather than seeking total certainty.", color: "emerald" },
    { code: "C", label: "Relationship Trigger", meaning: "Stress rises through conflict, disrespect, isolation or difficult interactions.", interpretation: "Your responses suggest stress rises through conflict, disrespect, isolation or difficult interactions.", nextStep: "Strengthen communication, support and interpersonal boundaries.", color: "yellow" },
    { code: "D", label: "Control Trigger", meaning: "Stress rises when autonomy, influence or decision rights are limited.", interpretation: "Your responses suggest stress rises when autonomy, influence or decision rights are limited.", nextStep: "Identify the smallest area of choice or influence and negotiate decision rights.", color: "orange" },
    { code: "E", label: "Evaluation Trigger", meaning: "Stress rises when performance, reputation or comparison feels highly visible.", interpretation: "Your responses suggest stress rises when performance, reputation or comparison feels highly visible.", nextStep: "Clarify standards and separate specific feedback from global self-worth.", color: "purple" },
  ],
  dimensions: [],
};
