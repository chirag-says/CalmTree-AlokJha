      ...
      <article className="mx-auto max-w-3xl px-5 py-12 md:py-16">
        ...
        <Section title="2. Information We Collect">
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              <strong>Personal identifiers:</strong> name, email address, and contact details you
              provide when signing up for newsletters, contacting us, or enrolling in courses.
            </li>
            <li>
              <strong>Usage data:</strong> pages visited, time spent, device type, browser, and
              approximate location (city/region level) via analytics tools.
            </li>
            <li>
              <strong>Assessment responses:</strong> answers you provide during self-check quizzes
              and assessments. These are used to generate your personalised report and are stored
              securely.
            </li>
            <li>
        ...
        <Section title="4. Cookies and Tracking">
          <p>
            ...
            traffic, and understand how visitors interact with our site. You can manage cookie
        ...
        <Section title="5. Data Sharing and Third Parties">
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              <strong>Service providers:</strong> trusted vendors who help us host the website, send
              emails, and process payments (where applicable).
            </li>
            <li>
          ...
          <p>
            All third-party providers are contractually bound to keep your data confidential and
            secure.
          </p>
        </Section>
        ...
        <Section title="6. Data Security">
          <p>
            ...
            against unauthorised access, alteration, disclosure, or destruction. However, no
